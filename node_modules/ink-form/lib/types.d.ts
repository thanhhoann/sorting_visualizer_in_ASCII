 ...
 */
export declare type Description = string | string[] | JSX.Element | undefined | false;
/**
...
export declare type ValueOfField<T extends FormField> = T extends AbstractFormField<any, infer V> ? V : never;
export declare type TypeOfField<T extends FormField> = T extends AbstractFormField<infer V, any> ? V : never;
export declare type AbstractFormField<T extends string, V> = {
    /**
...
export declare type FormFieldBoolean = AbstractFormField<'boolean', boolean> & {};
export declare type FormFieldString = AbstractFormField<'string', string> & {
...
export declare type FormFieldInteger = AbstractFormField<'integer', number> & {
    min?: number;
    max?: number;
...
export declare type FormFieldFloat = AbstractFormField<'float', number> & {
    min?: number;
    max?: number;
    /** The user can use the arrow keys to increase or decrease the value by that step amount. */
    step?: number;
...
export declare type FormFieldSelect = AbstractFormField<'select', string> & {
    options: Array<{
        label?: string;
        value: string;
    }>;
};
export declare type FormFieldMultiSelect = AbstractFormField<'multiselect', string[]> & {
    options: Array<{
        label?: string;
        value: string;
    }>;
...
export declare type FormFieldRendererProps<T extends FormField> = {
    field: T;
    form: FormStructure;
    value?: ValueOfField<T>;
...
export declare type SpecificFormFieldRendererProps<T extends FormField> = FormFieldRendererProps<T> & {
